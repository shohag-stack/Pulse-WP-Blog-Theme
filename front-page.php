    ...
    ?>
            <div>
                ...
                <a href="<?php echo esc_url(get_permalink()); ?>">
                    <h2 class="text-3xl font-semibold mt-2 mb-1"> <?php the_title(); ?> </h2>
                </a>
        ...
        ?>
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <a href="<?php echo esc_url(get_permalink()) ?>">
                            <h4 class="text-xl font-medium leading-tight"> <?php the_title() ?></h4>
                        </a>
                        <p>
                            <?php
        ...
        <section class="relative py-[150px] px-6 bg-cover bg-center text-white" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'full')); ?>');">
            <div class="text-center max-w-2xl mx-auto">
                ...
                <a href="<?php echo esc_url(get_the_permalink()) ?>">
                    <h1 class="text-3xl md:text-4xl font-serif my-4"> <?php the_title(); ?></h1>
                </a>
    ...
    <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        ?>
                <div>
                    ...
                    <a href="<?php echo esc_url(get_the_permalink()) ?>">
                        <h2 class="text-3xl font-semibold mt-2 mb-1"><?php _e(the_title()) ?></h2>
                    </a>
            ...
            ?>
                    ...
                    <li class="border-b pb-6 border-color-black-500">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <a href="<?php echo esc_url(get_the_permalink()) ?>">
                                    <h4 class="text-xl font-medium leading-tight mb-2"> <?php the_title() ?></h4>
                                </a>
